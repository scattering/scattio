...
# Author: Paul Kienzle
"""
Translate coordinates between real and reciprocal space.

Convert be neutron wavelength, velocity and energy.
"""
import numpy
...
def neutron_energy(wavelength):
    ...
    where:
        ...
        $m_n$ = neutron mass in kg
    """
    return ENERGY_FACTOR / numpy.asarray(wavelength)**2
